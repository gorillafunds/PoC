...
export const WrapperLockAbi = [
  ...
  },
  {
    constant: false,
    inputs: [],
    name: 'withdrawBalanceDifference',
  ...
  },
  {
    constant: false,
    inputs: [
      { name: '_differentToken', type: 'address' },
  ...
  },
  {
    inputs: [
      ...
      { name: '_erc20old', type: 'bool' },
      { name: '_proxyEfx', type: 'address' },
      { name: '_proxyV2', type: 'address' },
    ],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'constructor',
