...
export const MatchingMarketAbi = [
  {
    constant: true,
    inputs: [],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'buy_gem', type: 'address' },
      { name: 'min_fill_amount', type: 'uint256' },
    ],
    name: 'sellAllAmount',
  ...
  {
    constant: false,
    inputs: [{ name: 'matchingEnabled_', type: 'bool' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'maxTakeAmount', type: 'uint128' },
    ],
    name: 'take',
    outputs: [],
    payable: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'buy_amt', type: 'uint256' },
      { name: 'pay_gem', type: 'address' },
      { name: 'max_fill_amount', type: 'uint256' },
    ],
    name: 'buyAllAmount',
    outputs: [{ name: 'fill_amt', type: 'uint256' }],
    payable: false,
  ...
  {
    constant: false,
    inputs: [{ name: 'buyEnabled_', type: 'bool' }],
    name: 'setBuyEnabled',
    outputs: [{ name: '', type: 'bool' }],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ name: 'close_time', type: 'uint64' }],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
