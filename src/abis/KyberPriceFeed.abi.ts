...
export const KyberPriceFeedAbi = [
  ...
  {
    constant: false,
    inputs: [{ name: '_updater', type: 'address' }],
    name: 'setUpdater',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ name: '_maxSpread', type: 'uint256' }],
    name: 'setMaxSpread',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { name: 'ofRegistrar', type: 'address' },
      { name: 'ofKyberNetworkProxy', type: 'address' },
      { name: 'ofMaxSpread', type: 'uint256' },
