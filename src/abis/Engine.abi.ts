...
export const EngineAbi = [
  ...
  {
    constant: true,
    inputs: [{ name: 'mlnAmount', type: 'uint256' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'registry', type: 'address' }],
    name: 'RegistryChange',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'amguPrice', type: 'uint256' }],
    name: 'SetAmguPrice',
    type: 'event',
  },
