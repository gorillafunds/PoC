...
export const KyberWhiteListAbi = [
  ...
  {
    constant: false,
    inputs: [{ name: '_sgdToWeiRate', type: 'uint256' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: 'category', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, name: 'category', type: 'uint256' },
      { indexed: false, name: 'sgdCap', type: 'uint256' },
    ],
    name: 'CategoryCapSet',
    type: 'event',
  },
