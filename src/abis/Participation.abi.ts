...
export const ParticipationAbi = [
  {
    constant: false,
    inputs: [{ name: 'shareQuantity', type: 'uint256' }],
    name: 'redeemQuantity',
    outputs: [],
    payable: false,
  ...
  },
  {
    ...
    outputs: [{ name: 'remainingShareQuantity', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'requestedAssets', type: 'address[]' },
    ],
  ...
  },
  {
    constant: false,
    inputs: [
      { name: 'requestedShares', type: 'uint256' },
      { name: 'investmentAmount', type: 'uint256' },
      { name: 'investmentAsset', type: 'address' },
    ],
  ...
  {
    constant: false,
    inputs: [{ name: 'requestOwner', type: 'address' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'assets', type: 'address[]' }],
    name: 'DisableInvestment',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, name: 'requestOwner', type: 'address' },
      { indexed: true, name: 'investmentAsset', type: 'address' },
      { indexed: false, name: 'requestedShares', type: 'uint256' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, name: 'requestOwner', type: 'address' }],
    name: 'CancelRequest',
    type: 'event',
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: 'assetQuantities', type: 'uint256[]' },
      { indexed: false, name: 'redeemedShares', type: 'uint256' },
    ],
    name: 'Redemption',
    type: 'event',
  },
