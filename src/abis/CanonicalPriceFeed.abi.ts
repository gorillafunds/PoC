...
export const CanonicalPriceFeedAbi = [
  ...
  },
  {
    ...
    name: 'hasValidPrices',
    outputs: [{ name: 'areRecent', type: 'bool' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    constant: true,
    inputs: [{ name: 'unsorted', type: 'uint256[]' }],
    name: 'medianize',
    outputs: [{ name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
  ...
  {
    inputs: [
      { name: 'ofStakingAsset', type: 'address' },
      { name: 'ofQuoteAsset', type: 'address' },
      { name: 'quoteAssetName', type: 'bytes32' },
      { name: 'quoteAssetSymbol', type: 'bytes8' },
      { name: 'quoteAssetUrl', type: 'string' },
      { name: 'quoteAssetIpfsHash', type: 'string' },
      { name: 'quoteAssetBreakInBreakOut', type: 'address[2]' },
      { name: 'quoteAssetStandards', type: 'uint256[]' },
      { name: 'quoteAssetFunctionSignatures', type: 'bytes4[]' },
      { name: 'updateInfo', type: 'uint256[2]' },
      { name: 'stakingInfo', type: 'uint256[3]' },
      { name: 'ofGovernance', type: 'address' },
    ],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'constructor',
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'ofPriceFeed', type: 'address' }],
    name: 'SetupPriceFeed',
    type: 'event',
  },
  {
