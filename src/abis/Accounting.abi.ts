...
export const AccountingAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'unclaimedFeesInDenominationAsset', type: 'uint256' },
    ],
    name: 'calcNav',
  ...
  },
  {
    ...
    outputs: [{ name: 'gavPerShareNetManagementFee', type: 'uint256' }],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    constant: false,
    inputs: [{ name: '_queryAsset', type: 'address' }],
    name: 'calcAssetGAV',
    outputs: [{ name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      { name: 'gav', type: 'uint256' },
      { name: 'feesInDenominationAsset', type: 'uint256' },
      { name: 'feesInShares', type: 'uint256' },
      { name: 'nav', type: 'uint256' },
      { name: 'sharePrice', type: 'uint256' },
      { name: 'gavPerShareNetManagementFee', type: 'uint256' },
    ],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    outputs: [
      { name: 'gav', type: 'uint256' },
      { name: 'nav', type: 'uint256' },
      { name: 'allocatedFees', type: 'uint256' },
